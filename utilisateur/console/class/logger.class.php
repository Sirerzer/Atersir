...
class logger {
	  public function __construct($status, $lld) {
		...
		private function filters() {
				...
				$this->log_ = preg_replace("/\\§f/", "<span style='color:#808080;'> ", $this->log_);
				$this->log_ = preg_replace("/\\§b/", "<span style='color:#0000FF;'> ", $this->log_);
				$this->log_ = preg_replace("/\\§c/", "<span style='color:#F08080;'> ", $this->log_);
				$this->log_ = preg_replace("/\\§7/", "<span style='color:#AAAAAA;'> ", $this->log_);
				$this->log_ = preg_replace("/\\§e/", "<span style='color:#FFFF55;'> ", $this->log_);
				$this->log_ = preg_replace("/\\§a/", "<span style='color:#55FF55;'> ", $this->log_);
				$this->log_ = preg_replace("/\\§l/", "<span style='text'> ", $this->log_);
